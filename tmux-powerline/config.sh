...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="nak"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/root/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/root/.mailcheckrc"
# }
